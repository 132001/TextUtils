...
export default function About(props) {
  ...
  <div className="accordion-item" style = {{color: props.mode === 'light'?'white' : 'black'}}>
    ...
    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style = {{color: props.mode === 'light'?'black' : 'light'}}>
  ...
  <div className="accordion-item" style = {{color: props.mode === 'light'?'black' : 'light'}}>
    <h2 className="accordion-header" id="headingTwo" style = {{color: props.mode === 'light'?'black' : 'light'}}>
